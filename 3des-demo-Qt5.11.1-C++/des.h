...
public:
    ...
    static bool RunPad(int nType,const unsigned char* In,unsigned datalen,unsigned char* Out,unsigned& padlen);
    /* /Brief 执行DES算法对文本加解密
        *
        ...
        * @return true--成功；false--失败；   */
    static bool RunDes(bool bType,bool bMode,const unsigned char* In,unsigned char* Out,unsigned datalen,const unsigned char* Key,unsigned keylen);
protected:
    //计算并填充子密钥到SubKey数据中
